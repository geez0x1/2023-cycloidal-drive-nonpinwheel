...
# Difference input/output over output turns
ax[1].plot(t, turns2deg*diff, color=c.rel_pos, label='Difference')
...
# Difference input/output over output turns
ax[2].plot(outputPos, turns2deg*diff, color=c.rel_pos, label='Difference')
ax[2].set_title('Difference in input/output position')
ax[2].set_xlabel('Output turns []')
ax[2].set_ylabel('Positioning inaccuracy [deg]')
ax[2].legend()
ax[2].grid()
